                        ...
                        <tr className="border-b border-border hover:bg-gray-50/50 transition-colors">
                          ...
                          <td className="px-6 py-4 text-center text-sm md:text-base text-foreground">
                            <div className="space-y-2">
                              <p>반환사유가 발생한 해당 월의 반환금 해당 월의</p>
                              <p>반환사유가 발생한 까지의 경과된 수강시간을 기준으로 반환금액을 반환한 금액</p>
                            </div>
                          </td>
                        </tr>
                      </tbody>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-12">
                ...
                <p className="text-base md:text-lg text-foreground leading-relaxed">
                  <span className="text-[#952839] font-semibold">결제 완료 후 7일 이내에 환불을 신청하고 수강 내역이 없는 경우,
                  <br />
                  전액 환불 처리됩니다.</span>
                </p>
              </div>
