                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3 text-muted-foreground leading-relaxed">
                      ...
                      <p className="mt-4">학생에게 필요한 것은</p>
                      <p>질문하기 쉬운 관계, 시험 전 멘탈을 이해하는 멘토,</p>
                      <p>그리고 수업 밖에서도 이어지는 관리입니다.</p>
                      <p className="mt-4">형·언니 같은 선생님과의 관계 속에서</p>
                      <p>학생은 압박이 아닌 안정감을 가지고 시험을 준비합니다.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              ...
              <div>
                ...
                <div className="space-y-3 text-muted-foreground leading-relaxed">
                  <p>인터프렙의 로고는</p>
                  <p>학생 한 명 한 명을 중심에 두는 교육 태도를 담고 있습니다.</p>
                  <p className="mt-4">소문자 기반의 워드마크와 'i' 심볼은</p>
                  <p>과장되지 않고, 디지털 환경에 안정적으로 어울리도록 설계되었습니다.</p>
                  <p>'i' 심볼은 학생을 상징하는 점과,</p>
