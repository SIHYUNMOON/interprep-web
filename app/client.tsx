        ...
        <section className="relative bg-gradient-to-b from-muted/30 to-background py-24 md:py-40 mb-16">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h1 
                className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#F5F5F5] mb-6 text-balance"
                style={{ textShadow: '0 2px 8px rgba(0, 0, 0, 0.35)' }}
              >
                SAT 전문 학원 <span className="text-[#952839]">인터프렙</span>
                <br />
                점수로 실력을 증명합니다
              </h1>
              <p 
                className="text-lg md:text-xl font-medium mb-8 text-pretty"
                style={{ 
              ...
              >
                <span className="text-white">인터프렙</span>은 SAT 점수 향상을 목표로 한 전문 학원입니다.
                <br />
