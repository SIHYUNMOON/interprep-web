                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm text-muted-foreground">
                        {[
                          ...
                          'UNC Chapel Hill (1명)', 'Washington University in St. Louis (3명)', 'University of Southern California (1명)',
                          ...
                          'UCSD (4명)', 'UC Davis (2명)', 'University of Texas at Austin (1명)', 'Carnegie Mellon University (1명)',
                        ].map((school, idx) => (
                          <div key={idx} className="flex items-center gap-2">
                            <span className="text-[#952839]">•</span>
                            <span>{school}</span>
