  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        {/* Hero Section */}
        <AnimatedSection className="bg-background py-16 md:py-20">
        ...
        <AnimatedSection className="py-4 md:py-8 pb-12 md:pb-16 bg-background">
          <div className="container mx-auto px-4">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-2">특강 환불 규정</h2>
