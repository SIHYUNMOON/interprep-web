                    ...
                    <table className="w-full table-fixed">
                      <thead>
                        <tr className="border-b border-border bg-muted/50">
                          <th colSpan={2} className="px-6 py-4 text-center font-semibold text-foreground border-r border-border" style={{ width: '40%' }}>
                            구분
                          </th>
                          <th className="px-6 py-4 text-center font-semibold text-foreground border-r border-border" style={{ width: '20%' }}>
                            반환사유 발생일
                          </th>
                          <th className="px-6 py-4 text-center font-semibold text-foreground" style={{ width: '40%' }}>
                            반환금액
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <tr className="border-b border-border hover:bg-gray-50/50 transition-colors">
                          <td colSpan={2} className="px-8 py-6 text-center text-sm md:text-base text-foreground border-r border-border">
                            제18조 제2장 제1호 및 제2호의 반환사유에 해당하는 경우
                          </td>
                          <td className="px-8 py-6 text-center text-sm md:text-base text-foreground border-r border-border">
                            교습을 할 수 없거나 교습 장소를 제공할 수 없게 된 날
                          </td>
                          <td className="px-8 py-6 text-center text-sm md:text-base text-foreground">
                        ...
                        {/* Row 2 */}
                        <tr className="border-b border-border hover:bg-gray-50/50 transition-colors">
                          <td className="px-8 py-6 text-center text-sm md:text-base text-foreground border-r border-border" rowSpan={4}>
                            <div className="py-2">
                              <div className="mb-2">제18조 제2항</div>
                              <div className="mb-3">제3호의 반환사유에</div>
                              <div>해당하는 경우</div>
                            </div>
                          </td>
                          <td className="px-8 py-6 text-center text-sm md:text-base text-foreground border-r border-border" rowSpan={3}>
                            <div className="py-2">
                          ...
                          <td className="px-8 py-6 text-center text-sm md:text-base text-foreground font-medium">
                            수강료의 2/3 환불
                          </td>
                        </tr>
                        ...
                        <tr className="border-b border-border hover:bg-gray-50/50 transition-colors">
                          <td className="px-8 py-6 text-center text-sm md:text-base text-foreground border-r border-border">
                            <div className="py-2">
                              <div className="mb-2">수강기간이</div>
                              <div className="mb-3">1개월 초과 하는</div>
                              <div>경우</div>
                            </div>
                          </td>
                          <td className="px-8 py-6 text-center text-sm md:text-base text-foreground border-r border-border">
                          ...
                          <td className="px-8 py-6 text-center text-sm md:text-base text-foreground">
                            <div className="leading-relaxed">
                              <p>반환사유가 발생한 해당 월의 반환 대상</p>
                              <p>수강료등(수강기간이 1개월 이내인 경우의</p>
                              <p>기준에 따라 산출한 금액을 말한다)과</p>
                              <p>나머지 월의 수강료등의 전액을 합산한 금액</p>
                            </div>
                          </td>
                        </tr>
                      </tbody>
